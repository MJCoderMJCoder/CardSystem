...
<body onload="tip()" style="background-image: url(/CardSystem/images/bg.jpg)">
	<div id="header">
		<a href="/CardSystem/index.jsp" class="logo"><img src="/CardSystem/images/logo.png" alt=""></a>
	</div>
	<div align="center" style="margin-top: 100px">
		<form action="adminLogin" style="font-size: 16px">
			账号：<input type="text" name="username" style="background: url(/CardSystem/images/form-textfield-234.gif);border:0px"><br><br>
