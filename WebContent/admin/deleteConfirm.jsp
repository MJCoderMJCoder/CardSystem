...
<body style="background-image: url(/CardSystem/images/bg.jpg)">
	<div class="content" style="padding-left: 30%">
		<h3>您确定要注销 ${requestScope.number } ?</h3>
		<a href="admin/deleteConfirm.action?number=${requestScope.number }"><button class="buttoncss">确定</button></a>
		<a href="/CardSystem/admin/deleteCard.jsp?tip=null"><button class="buttoncss">取消</button></a>
	</div>
</body>
</html>