...
<body style="background-image: url(/CardSystem/images/bg.jpg)">
	<div class="content" style="padding-left: 30%">
		<h3>您确定要解锁 ${requestScope.number } ?</h3>
		<a href="admin/unlockConfirm.action?number=${requestScope.number }"><button class="buttoncss">确定</button></a>
		<a href="/CardSystem/admin/lockCard.jsp?tip=null"><button class="buttoncss">取消</button></a>
	</div>
</body>
</html>