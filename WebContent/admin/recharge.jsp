	...
	<div class="content" style="padding-left: 30%">
		...
		<form action="recharge">
			<table style="font-size: 16px">
				...
				<tr>
					<td>金额:</td>
					<td><input type="text" name="money" style="background: url(/CardSystem/images/form-textfield-234.gif);border:0px"></td>
				</tr>
				<tr>
					<td><input type="submit" value="充值" style="font-size: 16px"></td>
				</tr>
			</table>
		</form>
	</div>
