	...
	<div id="body">
		<div class="content" align="center">
			...
			<div align="center" style="font-size: 18px">
				...
				<a href="history.action?pageNumber=1&number=${requestScope.historyList[0].number}">第一页</a>&nbsp;&nbsp;
				<s:if test="#page>1">
				<a href="history.action?pageNumber=${requestScope.currentPage - 1}&number=${requestScope.historyList[0].number}">上一页</a>&nbsp;&nbsp;
				</s:if>
				<s:if test="#page<#last">
				<a href="history.action?pageNumber=${requestScope.currentPage + 1}&number=${requestScope.historyList[0].number}">下一页</a>&nbsp;&nbsp;
				</s:if>
				<a href="history.action?pageNumber=${requestScope.pageCount}&number=${requestScope.historyList[0].number}">最后页</a>&nbsp;&nbsp;
			</div>
		</div>
	</div>
</body>
