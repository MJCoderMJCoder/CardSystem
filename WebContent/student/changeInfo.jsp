		...
		<form action="changeInfo">
			<table style="font-size: 16px">
				<tr>
					...
					<td><input type="text" name="name" style="background: url(/CardSystem/images/form-textfield-234.gif);border:0px;visibility: hidden;"></td>
				</tr>
				<tr>
					
					<td><input type="text" name="sex" style="background: url(/CardSystem/images/form-textfield-234.gif);border:0px;visibility: hidden;"></td>
				</tr>
				<tr>
					<td> 身份证号:</td>
